...
* [Clarinet](https://github.com/hirosystems/clarinet) ⭐ 352 | 🐛 197 | 🌐 Rust | 📅 2026-09-11 - Clarity runtime packaged as a CLI, facilitates development and testing of Clarity smart contracts.
...
* [secondlayer](https://github.com/ryanwaits/secondlayer) ⭐ 6 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-10 - TypeScript code generation for Clarity contracts with React hooks and testing utilities. Inspired by Clarigen.
...
* [Stacks.js](https://github.com/stx-labs/stacks.js) ⭐ 975 | 🐛 96 | 🌐 TypeScript | 📅 2026-09-08 - Monorepo for JavaScript libraries for interacting with the Stacks Blockchain.
* [Stacks Connect](https://github.com/stx-labs/connect) ⭐ 89 | 🐛 50 | 🌐 TypeScript | 📅 2026-09-10 - A library for connecting apps with Stacks accounts.
...
* [@stacks/cli](https://github.com/stx-labs/stacks.js/tree/main/packages/cli) ⭐ 975 | 🐛 96 | 🌐 TypeScript | 📅 2026-09-08 - Command line interface for interacting with auth, storage, and transactions.
