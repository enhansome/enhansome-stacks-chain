...
* [Clarinet](https://github.com/hirosystems/clarinet) ⭐ 352 | 🐛 195 | 🌐 Rust | 📅 2026-08-28 - Clarity runtime packaged as a CLI, facilitates development and testing of Clarity smart contracts.
...
* [secondlayer](https://github.com/ryanwaits/secondlayer) ⭐ 6 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-29 - TypeScript code generation for Clarity contracts with React hooks and testing utilities. Inspired by Clarigen.
...
* [STX20](https://github.com/fess-v/stx20-standard) ⭐ 26 | 🐛 8 | 📅 2024-09-05 - Protocol to create and share digital artifacts on Stacks.
* [clarity-bitcoin](https://github.com/friedger/clarity-bitcoin) ⭐ 20 | 🐛 4 | 🌐 Clarity | 📅 2026-06-23 - A library to verify Bitcoin transactions.
* [uint256](https://github.com/KStasi/clarity-uint256-lib) ⭐ 9 | 🐛 2 | 🌐 TypeScript | 📅 2020-08-17 - A library for converting values into 256-bits.
...
* [Stacking Pools](https://github.com/friedger/clarity-stacking-pools) ⭐ 3 | 🐛 4 | 🌐 HTML | 📅 2025-04-23 - Wrapper contracts of PoX for stacking pools.
* [Stacks Pools](https://github.com/degen-lab/stacks-pools) ⭐ 0 | 🐛 10 | 🌐 HTML | 📅 2025-07-10 - Decentralized Stacking Pool.

## App Development

### Client Libraries

* [Stacks.js](https://github.com/stx-labs/stacks.js) ⭐ 975 | 🐛 92 | 🌐 TypeScript | 📅 2026-08-24 - Monorepo for JavaScript libraries for interacting with the Stacks Blockchain.
* [Stacks Connect](https://github.com/stx-labs/connect) ⭐ 89 | 🐛 50 | 🌐 TypeScript | 📅 2026-08-05 - A library for connecting apps with Stacks accounts.
...
* [Sign-In With Stacks](https://github.com/pradel/sign-in-with-stacks/) ⭐ 1 | 🐛 0 | 🌐 TypeScript | 📅 2026-06-13 - A library for creating and verifying Sign-In with Stacks messages.
* [x402 Stacks](https://www.x402stacks.xyz) - A protocol and SDK for building payment-gated APIs on the Stacks Blockchain.

### CLI

* [@stacks/cli](https://github.com/stx-labs/stacks.js/tree/main/packages/cli) ⭐ 975 | 🐛 92 | 🌐 TypeScript | 📅 2026-08-24 - Command line interface for interacting with auth, storage, and transactions.

### Indexing and Querying APIs

* [Self-Hosted Docker](https://github.com/stacks-network/stacks-blockchain-docker) ⭐ 36 | 🐛 17 | 🌐 Shell | 📅 2026-07-20 - Tool to run a self-hosted Stacks node with Docker.
...
* [Stacks Monitoring](https://github.com/alexlmiller/stacks-monitoring) ⭐ 1 | 🐛 0 | 🌐 Python | 📅 2026-08-12 - Grafana Dashboard for Stacks nodes.
